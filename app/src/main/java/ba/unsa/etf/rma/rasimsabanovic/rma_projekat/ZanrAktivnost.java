...
public class ZanrAktivnost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView lista_zanrova = (ListView)findViewById(R.id.listaZanrovi);

        final ZanrAdapter adapter;
        adapter = new ZanrAdapter(this, R.layout.zanr_u_listi, zanrovi, getResources());
        lista_zanrova.setAdapter(adapter);

        dugme_glumci.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ZanrAktivnost.this, GlumciAktivnost.class);
                i.putExtra("glumci", glumci);
                i.putExtra("reziseri", reziseri);
                i.putExtra("zanrovi", zanrovi);
                ZanrAktivnost.this.startActivity(i);
            }
        });
        ...
        dugme_reziseri.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ZanrAktivnost.this, ReziseriAktivnost.class);
                i.putExtra("glumci", glumci);
                i.putExtra("reziseri", reziseri);
                i.putExtra("zanrovi", zanrovi);
                ZanrAktivnost.this.startActivity(i);
